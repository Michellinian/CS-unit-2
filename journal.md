...
Today we stopped what we were doing for unit 2, and we started off the lesson with learning about different types of computer memories. I felt that it was too much information on one go, so I decided to study about memories, along with the computer structure outside class, on my spare time. Then we moved on to a new topic about "job automation". We did a debate using the style of "Socratic circle", where 2 people, one representing the programmer side, and one the employer or the manager, sat in the center of the room. The rest were audiences watching the debate, and then they would give feeback after the people in the middle stop debating. The debate was about whether job automation is a good thing or a bad thing. Throughout the debate, I thought that job automation should be a win-win situation both for the employers, and for the programmers. This is because the programmer or the worker, would not have to do repetitive work every day, but they can use the spare time created by job automation, to pursue their individual interest. At the same time, the company or the industry would increase their efficiency because computers are consistent: they can do the jobs faster and more accurately than humans. Although the reason why this was a good debate topic was because this was a matter of ethical problem. I think that if the employees don't tell that they've automated the job, it is the same as stealing money, and deceiving the boss in doing their job, while they're actually playing around. Basically, there are pros and cons to this topic, as all things do. Overall this class was a new style, and I enjoyed having a discussion based class. 
